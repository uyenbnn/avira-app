...
function loadConfig() {
  ...
  const cfg = {
    ...
    mvpGatewayBaseUrl: process.env.MVP_GATEWAY_BASE_URL || '',
    mvpPlatformBaseUrl: process.env.MVP_PLATFORM_BASE_URL || '',
    mvpIamBaseUrl: process.env.MVP_IAM_BASE_URL || '',
    mvpAppBaseUrl: process.env.MVP_APP_BASE_URL || '',
