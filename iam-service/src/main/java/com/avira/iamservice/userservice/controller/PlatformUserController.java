...
public class PlatformUserController {
    ...
    public PlatformUserResponse create(@RequestBody CreatePlatformUserRequest request) {
    ...
    @GetMapping("/{userId}")
    public PlatformUserResponse findById(@PathVariable UUID userId) {
        return platformUserService.findById(userId);
    }
}
